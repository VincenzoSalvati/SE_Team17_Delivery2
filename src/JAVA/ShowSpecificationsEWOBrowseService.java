...
public class ShowSpecificationsEWOBrowseService {

    private Connection con;

    public String getShowSpecificationsEWOBrowseToJSON(MySqlDbConnection db) {
        ...
        try {
            ...
            rs = stmt.executeQuery("SELECT * FROM specifications WHERE id_activity=" + 4 + " AND week_activity = " + 1);
            int i = 0;
            while (rs.next()) {
